...
group_require.add_argument("-a","--annot",dest="annot",required=True,help="annotation file")
...
with open(options.annot,'r') as input:
	line = input.readline()
	while (line):
		line = line.strip().split("\t")
